...
public class AIController {
    ...
    public String home(@PathVariable String message) {
        ChatResponse response = chatClient
                .prompt(message)
                .tools(dateTimeTool,newsTool,stockMarketTool).call()
                .chatResponse();
                //.content();
...
//        return vectorStore.similaritySearch(text);
    ...
    public String productInfo(@PathVariable String query) {
        ...
        PromptTemplate promptTemplate= PromptTemplate.builder().
                template(template).
                build();
/*QuestionAnswerAdvisor will replace the query and the question_answer_context in the above template*/
        return chatClient.prompt(query).
                advisors(QuestionAnswerAdvisor.
                        builder(vectorStore)
                                .promptTemplate(promptTemplate).build()).call().content();
    }
}
